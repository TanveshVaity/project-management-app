        ...
        <div className="flex items-center justify-between bg-white px-4 py-3 dark:bg-black dark:px-4 dark:py-3">
            <div className="flex items-center gap-8">
                ...
                <div className="relative flex h-min w-[200px]">
                    <Search  className="absolute left-[5px] top-1/2 h-5 w-5 -translate-y-1/2 transform cursor-pointer dark:text-white"/>
                    <input 
            ...
            <div className="flex items-center">
                ...
                >
                    {isDarkMode ? (
                        ...
                        <Moon className="h-6 w-6 cursor-pointer dark:text-white dark:hover:text-black"/>
                    )}
                </button>
                <Link  
                    href="/settings"
